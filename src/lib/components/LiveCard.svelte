...
<article
	class="grain rounded-2xl border border-l-4 border-border border-l-gold bg-surface p-6 sm:p-8"
>
	<time datetime={live.date} class="font-display text-2xl font-semibold text-brand-ink sm:text-3xl">
