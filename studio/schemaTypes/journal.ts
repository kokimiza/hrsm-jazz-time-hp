...
export default defineType({
	...
	fields: [
		...
		defineField({
			...
			description:
				'掲載場所（一覧・詳細ページ）によって、画像の四辺が少し見切れることがあります。個別に調整することはできないので、主役（人物・楽器など）はなるべく写真の中央に写っているものを選んでください。画像をアップロードした後に出てくる丸いアイコンをクリックすると、見切れても残したい部分を自分で切り取って選べます。'
